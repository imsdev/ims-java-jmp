	...
	public static void main(String[] args) {
		...
		try {
			...
			while (messageQueue.getUnique(inputMessage)) {
				...
				// typically would have some database interaction here

				// get customer information
				if (action.trim().equalsIgnoreCase("get")) {

					Customer customerInfo = customerService.getCustomerInfo(customerNumber);
					...
					if (customerInfo != null) {
						...
						// insert the populated CustomerOutputMessage into
						// message queue
